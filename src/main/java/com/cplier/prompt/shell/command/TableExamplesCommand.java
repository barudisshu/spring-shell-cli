...
import com.cplier.prompt.shell.common.table.LocalDateFormatter;
...
public class TableExamplesCommand {
  ...
  public String[] CONTINENTS = {
    "Europe", "North America", "South America", "Africa", "Asia", "Austraila and Oceania"
  };
  ...
  public void sampleTables() {
    Object[][] sampleData = new String[][] {CONTINENTS, COUNTRIES1, COUNTRIES2};
