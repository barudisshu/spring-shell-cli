...
public class InputReader {
   ...
   * Passing "" or null among optionsAsList means that an empty answer is allowed, in these cases
   * this method returns empty String "" as the result of its execution.
   */
